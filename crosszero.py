...
def draw_grid(scr):
    ...
    pygame.draw.line(scr, (0, 0, 0), (0, 100), (300, 200), 3)
...
screen = pygame.Syrface(SCREEN_SIZE)
    ...
    for event in pygame.event.get():
        ...
        if event.type == pygame.MOUSEBUTTONDOWN and not game_over:
            ...
            if player_win or ai_win:
                game_over = True
                if player_win:
                    pygame.display.set_caption("Ваша победа")
                else:
                    pygame.display.set_caption("Победа компьютера")
